...
/**
 * An ementation of {@link org.apache.hama.HamaAdmin} to manage the matrix's
 * namespace, and table allocation & garbage collection.
 */
public class HamaAdmin {
  static final Logger LOG = Logger.getLogger(HamaAdmin.class);
   ...
   */
  public HamaAdmin(Configuration conf) throws MasterNotRunningException {
    this.conf = conf;
   ...
   * @param admin
   */
  public HamaAdmin(Configuration conf, HBaseAdmin admin) {
    this.conf = conf;
    this.admin = admin;
    initialJob();
  }
